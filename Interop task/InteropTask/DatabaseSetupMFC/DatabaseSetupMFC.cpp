...
// DatabaseSetupMFC.cpp : Defines the class behaviors for the application.
//
...
// CDatabaseSetupMFCApp construction
...
// The one and only CDatabaseSetupMFCApp object

CDatabaseSetupMFCApp theApp;


// CDatabaseSetupMFCApp initialization
